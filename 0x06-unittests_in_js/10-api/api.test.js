...
describe('Integration Testing', () => {
  ...
  describe('GET /available_payments', () => {
    ...
    it('Should return JSON object when parsed', () => {
      const params = {
        url: 'http://localhost:7865/available_payments',
        method: 'GET',
      };
      ...
      request(params, (err, res, body) => {
        ...
        expect(bodyParsed).to.deep.equal(refObj);
      });
    });
  });

  describe('POST /login', () => {
    it('should login with the correct userName parameter', () => {
      const params = {
    ...
    it('should return undefined with no userName parameter', () => {
      const params = {
        url: 'http://localhost:7865/login',
        method: 'POST',
      };
